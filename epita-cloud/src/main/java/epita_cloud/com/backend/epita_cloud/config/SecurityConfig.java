...
public class SecurityConfig {
    ...
    /**
     * Baseline only: every request must carry a valid Cognito-issued JWT.
     * Which role can call which endpoint is decided per controller method with @PreAuthorize.
     */
    @Bean
